    ...
    return (
      <span>
        <Popup
          ...
          position="top left"
          trigger={
            <div className="action-btn" style={{ paddingLeft: 0, float: "left", cursor: "pointer" }}>
              <div>
        ...
        { this.props.restoreSelection
          ? (
            <div onClick={this.props.restoreSelection} className={`text ${classNames.add_text}`} style={{ float: "left", paddingLeft: "1rem", cursor: "pointer" }}>
