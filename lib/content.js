(function(window, document) {
    ...
    document.addEventListener("mouseover", function(e) {
        ...
        span.className = "draaft-icon btn";

        span.addEventListener("click", function() {
            cleanUp();
            bookmarkSelection(null, img.src);
        });
    ...
    function markSelection() {
        ...
        selectionIcon.className = "draaft-icon btn";
        selectionIcon.addEventListener("mousedown", function() {
            bookmarkSelection(selection.toString())
        });
    ...
    function bookmarkSelection(quote, href) {
